                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 px-2 rounded-lg text-sm font-medium transition-all ${
                      scanType === type
                        ...
                        : 'bg-gray-800 text-gray-400 border border-gray-700 hover:bg-gray-750 hover:text-gray-200 hover:border-gray-600'
                    }`}
                  >
                    {type}
                  </button>
...
function ResultSection({ title, items, accent }) {
  const colors = {
    red: {
      title: 'text-red-400',
      badge: 'bg-red-950/70 text-red-400 border border-red-800/60',
      empty: 'text-gray-600',
    },
    orange: {
      title: 'text-orange-400',
      badge: 'bg-orange-950/70 text-orange-400 border border-orange-800/60',
      empty: 'text-gray-600',
    },
    blue: {
      title: 'text-blue-400',
      badge: 'bg-blue-950/70 text-blue-400 border border-blue-800/60',
      empty: 'text-gray-600',
    },
  }
